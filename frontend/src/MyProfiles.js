    ...
    >
      ...
      >
        ...
        <div style={styles.navButtons}>
          <button style={styles.navButton} onClick={() => navigate("/employee-profile")}>
            Add Another Profile
          </button>
              ...
              <div style={{ flex: 1, minWidth: 220 }}>
                ...
                <div>
                  ...
                  <div style={buttonRowStyle}>
                    ...
                    <button onClick={() => handleDelete(p.id)} style={redButtonStyle}>
                      🗑 Delete
                    </button>
...
<p><strong>Admin Phone:</strong> 1234567890</p>
